...
counts_data <- counts_data[, -c(1:4)]  # Remove metadata columns

# Remove outlier sample
outlier_sample <- "C_28"
counts_data <- counts_data[, !colnames(counts_data) %in% outlier_sample]
...
# Preprocess metadata
outlier_sample <- "control-28"
coldata <- coldata[!coldata$title %in% outlier_sample, ]  # Remove outlier metadata
